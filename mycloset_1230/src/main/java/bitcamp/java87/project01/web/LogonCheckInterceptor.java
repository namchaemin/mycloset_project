	...
	public boolean preHandle(	HttpServletRequest request,
		...
		if(   user != null ||user1 !=null   )  {
			...
			if(		uri.indexOf("addUserView") != -1 	|| 	uri.indexOf("addUser") != -1 || 
					...
					uri.indexOf("checkDuplication") != -1 ){
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
			if(uri.indexOf("emailKey") != -1 ||uri.indexOf("emailCheck") != -1 ||uri.indexOf("botPage") != -1 ||	uri.indexOf("getJsonBot") != -1 ||	uri.indexOf("addUser") != -1 ||	uri.indexOf("login") != -1  ||	uri.indexOf("checkDuplication") != -1 || uri.indexOf("facebook") != -1 || uri.indexOf("updateUser") != -1){
